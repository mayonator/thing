...
module.exports = {
    create(title, color, desc, fields, thumbnail, footer) {
        ...
        if (footer == null) embed.setFooter('|  Created by foobball#7416  |  https://i.bonk.ml  |', 'https://cdn.discordapp.com/avatars/219541416760705024/ad17ab40b26152e45115693b7ac07f08.png?size=256');
